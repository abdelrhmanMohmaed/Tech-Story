...
$pr = new Product;
$prods = $pr->selectAll('products.id AS prodId , products.name AS prodName , cats.name AS catName, img,
pieces_on, price, products.created_at AS prodCreatedAt');
                ...
                <tbody>
                    <?php foreach ($prods as $index => $prod) : ?>
                        <tr>
                            ...
                            <td><?= $prod['catName']; ?></td>
                            <td>
                                <img height="50px" src="<?= URL . "uploads/" . $prod['img'];  ?>" alt="">
                            </td>
                            <td><?= $prod['pieces_on']; ?></td>
                            <td>$<?= $prod['price']; ?></td>
